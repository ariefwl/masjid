          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Sapi <span>| <a href="{{ url('groupSapi'); }}">Lihat detail</a></span></h5>
            ...
            <div class="card-body">
              ...
              <div class="activity">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php $no=1; foreach ($shohibul as $key ) { ?>
                            <tr>
                                <td><?= $no++; ?></td>
                                <td><?= $key['nama']; ?></td>
                                <td><?= $key['alamat']; ?></td>
...
<script>
  document.addEventListener("DOMContentLoaded", () => {
    new ApexCharts(document.querySelector("#columnChart"), {
      ...
      xaxis: {
        categories: ['Kel 1', 'Kel 2', 'Kel 3', 'Kel 4', 'Kel 5', 'Kel 6', 'Kel 7', 'Kel 8', 'Kel 9', 'Kel 10', 'Kel 11', 'Kel 12', 'Kel 13', 'Kel 14', 'Khotib', 'Pengurus', 'Ponpes', 'Panitia Tambahan','Parkir Untung','Parkir Papang','Pasar Rasamala','Parkir Sarinah','Tugu Beton','Ojek Pasar','Ojek Online','Relawan','Pasar Pisang','Lingkungan','Panitia Inti','Jagal','Kerja Bhakti'],
        // categories: [ {{ $klp }} ],
      },
      yaxis: {
        title: {
